...
public class Snake {
	...
	public void update() {
		...
		Location newHeadLoc = null;
		switch (currentDirection) {
		case UP:
			//head.setLocation(new Location(head.getLocation().x, head.getLocation().y-1));
			newHeadLoc = new Location(head.getLocation().x, head.getLocation().y-1);
		...
		case LEFT:
			...
			newHeadLoc = new Location(head.getLocation().x-1, head.getLocation().y);
	...
	public boolean isLocationOnSnake(Location loc) {
		...
		if(head.getLocation().equals(loc)) return true;
